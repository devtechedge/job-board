...
## Run
Install packages in this folder, then use the start script in package.json.
Press i for the iOS simulator or a for Android. Scan the QR code with Expo Go.
Default API origin is production Vercel. See .env.example to change it.
Apply is always external to the employer ATS.
